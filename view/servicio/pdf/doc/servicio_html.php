    ...
    <table style="width: 80%;border: solid 1px #5544DD; border-collapse: collapse" align="center">
        <thead>
            <tr>
                ...
                <th style="width: 10%; text-align: left; border: solid 1px #007500; background: #007500; text-color: #FFFFFF;"><span style="color: #FFFFFF;">ID</span></th>
        ...
        <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td style="width: 10%; text-align: left; border: solid 1px #007500">
                                    <?=$row['idServicio'] ?>
                            </td>                            
