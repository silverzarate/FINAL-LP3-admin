...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
		...
		<tr>
           <td style="width:50%;" >
			<?php
				$cadenaRazonSocial = "";
				$cadenaRazonSocial .= "
					<pre><b>CLIENTE: </b>" .$cliente['razonsocial'].
						"<br><b>CI / RUC: </b>".$cliente['ci'].
						"<br><b>DOMICILIO: </b>".$cliente['ciudad'].                        
					"</pre>";
    ...
    foreach ($arrDetalles as $fila) {
        $idServicio = $fila["idConcepto"];
        $cantidad = $fila['cantidad'];
        $concepto = $fila['concepto'];
        $importe=$precio_unitario = $fila['unitario'];

        $insertdetail = $object->insertdetail($numero,$idServicio,$cantidad,$importe);
        
        $precio_unitario_f=number_format($precio_unitario,2);//Formateo variables
