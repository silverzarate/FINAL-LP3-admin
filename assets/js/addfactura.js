$(document).ready(function() {
    ...
    WindowCenter('pdf/factura_pdf.php?fecha='+fecha+'&idCliente='+idCliente +'&idFormaPago='+idFormaPago, 'Vista Previa de Factura', '', '1024', '768', 'true');
